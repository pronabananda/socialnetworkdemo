...
var StartYear =currentTime.getFullYear()-60; //First Year in drop down year selection
...
var CalBgColor="A1D3FF";//Background color of Calendar window.
...
function NewCssCal(pCtrl,pFormat,pScroller,pShowTime,pTimeMode,pHideSeconds) {
	...
	if (exDateTime!="")	{ //Parse existing Date String
		...
		if ((Cal.Format.toUpperCase()=="DDMMYY") || (Cal.Format.toUpperCase()=="DDMMMYY")) {
			if (DateSeparator=="") {
...
function FormatDate(pDate)
{
	...
	if (this.Format.toUpperCase()=="DDMMyy")
		return (pDate+DateSeparator+MonthDigit+DateSeparator+this.Year);

	else if (this.Format.toUpperCase()=="DDMMMyy")
		return (pDate+DateSeparator+this.GetMonthName(false)+DateSeparator+this.Year);
	else if (this.Format.toUpperCase()=="MMDDyy")
		return (MonthDigit+DateSeparator+pDate+DateSeparator+this.Year);
	else if (this.Format.toUpperCase()=="MMMDDyy")
